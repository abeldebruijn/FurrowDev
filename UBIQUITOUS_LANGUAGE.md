...
| **Project Settings**         | The project-level screen or controls where a **User** manages metadata for a **Project**. (new) | Preferences, config, edit modal |
...
| **Ideas Tab**          | The **Project Dashboard** tab reserved for project ideas.                                              | Concepts tab, proposal tab               |
...
> **Dev:** "When a user drags a **Widget Variant** out of the **Add Widget Panel**, when should the **Placement Preview** appear?"
> **Domain expert:** "Only after the drag leaves the panel and enters the **Drop Zone** on the **Project Dashboard**."
> **Dev:** "Once released there, do we store the **Widget Layout** immediately?"
> **Domain expert:** "Not yet. For now it updates the **Temporary Layout** only."
> **Dev:** "And deleting is possible both ways?"
> **Domain expert:** "Yes. A **Placed Widget** can be removed with **Inline Delete** or by dragging it onto the **Delete Drop Target** during **Edit Mode**."
