...
import ProjectVisionsPage from "../app/project/[project-id]/visions/page";

describe("ProjectVisionsPage", () => {
  beforeEach(() => {
  ...
  it("renders an enabled archive toggle when archived visions exist", async () => {
    ...
    expect(markup).toContain("/project/project-1/visions?archived=1");
  });
